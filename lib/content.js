...
const zones = [
  {
    ...
    monsters: [
      ...
      { id: 'gremlin', name: 'Gremlin', sprite: '◀●▄●▒▓█▌' },
      { id: 'direrat', name: 'Dire Rat', sprite: '◢●▒▓██▙╮' },
    ],
    boss: { id: 'rootfang', name: 'Rootfang the Ancient Treant', level: 9, sprite: '▜█◉▼◉▓███▛' },
  ...
  },
  {
    ...
    monsters: [
      ...
      { id: 'kobold', name: 'Kobold Miner', sprite: '◣▄▄◉●▒▓▌' },
    ],
  ...
  },
  {
    ...
    monsters: [
      { id: 'librarian', name: 'Zombie Librarian', sprite: '╒═╕▄▟▫▓▙' },
      { id: 'inkelem', name: 'Ink Elemental', sprite: '░▒○▓○▓▒░' },
      { id: 'tome', name: 'Cursed Tome', sprite: '│◉▬│█│●│' },
    ],
  ...
  },
  {
    ...
    monsters: [
      { id: 'cinderhound', name: 'Cinder Hound', sprite: '◀●▓▟▓██▛' },
      { id: 'magmaimp', name: 'Magma Imp', sprite: '▐◉◉▒▓▌╱▚' },
      { id: 'ashwraith', name: 'Ash Wraith', sprite: '◢◆▓◆▓▓◣░' },
    ],
    boss: { id: 'pyrelord', name: 'Pyrelord Kzz', level: 36, sprite: '◢█▙◤●▄●▟█◣' },
  ...
  },
  {
    ...
    monsters: [
      ...
      { id: 'golem', name: 'Crystal Golem', sprite: '◢█◆▙▜██▙' },
      { id: 'shade', name: 'Storm Shade', sprite: '↯█◉◉███▌' },
    ],
  ...
  },
  {
    ...
    monsters: [
      ...
      { id: 'segfault', name: 'Segfault Stalker', sprite: '░▒▐█▚▞█▌' },
      { id: 'dangling', name: 'Dangling Pointer', sprite: '◀█◆██▙═╌' },
    ],
    boss: { id: 'gc', name: 'The Garbage Collector', level: 54, sprite: '▪⇢░▒▓◉█╪██' },
    legendary: 'Mark-and-Sweep',
  },
  {
    id: 'prod', name: 'Production', min: 55, max: 60, flavor: 'Prod',
    monsters: [
      { id: 'heisenbug', name: 'Heisenbug', sprite: '▐◉███▓▒?' },
      { id: 'racecond', name: 'Race Condition', sprite: '▟◉█▙⇄░▒○' },
      { id: 'memleak', name: 'Memory Leak', sprite: '▐█▬▂▓██▌' },
      { id: 'daemon', name: 'Legacy Daemon', sprite: '◀┫◉▪▫▪┃╮' },
    ],
    boss: { id: 'rootcause', name: 'The Root Cause', level: 60, sprite: '◢██▛ ◉ ▜█◣' },
...
// The coins are part of the name, not decoration the renderer adds: `⛁` is the
// same glyph the vitals line uses for gold, so the nameplate and the purse read
// as the same currency. Every path that shows a monster name — nameplate, kill
// ticker, the banner's uppercase — picks them up for free.
const GOBLIN = { id: 'lootgoblin', name: '⛁ Loot Goblin ⛁', sprite: '◀$█▄▟⛁▓▌' };

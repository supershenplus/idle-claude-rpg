...
function classify(input) {
  ...
  if (tool === 'Bash') {
    ...
    if (!cmd) return null;
    if (cmd.includes('idle-claude-rpg')) return null; // no self-farming via /hero
...
module.exports = { classify, bashExitCode, countLines, TEST_RE, BUILD_RE, GIT_PUSH_RE, GIT_COMMIT_RE };

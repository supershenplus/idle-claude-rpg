...
// A span someone actually sat through, as opposed to `relTime`'s "how long ago".
// The two want different rounding: one coarse unit is right for "3h ago" and
// wrong for a session length, where reporting two and a quarter hours as "2h"
// throws away the part the player is reading it for.
function span(ms) {
...
module.exports = {
  ...
  visible, charWidth, width, fit, spread, row, centerAt, keepIndent, relTime, span,
